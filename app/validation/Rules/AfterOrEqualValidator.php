<?php
	/*
	 * Yêu cầu giá trị của trường phải là một ngày SAU hoặc bằng ngày được chỉ định (date).
	 */
	
	namespace App\validation\Rules;
	
	class AfterOrEqualValidator
	{
		private $date;
		...
		public function message($fieldName, $message): string
		{
			...
			return $fieldName . ' must be a date after or equal to ' . $this->date;
		}
	}