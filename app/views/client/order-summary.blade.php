...
@section('content')
    ...
    <section class="wf vh wh">
      ...
      <div class="la xf kh">
        <div class="a da">
          <div class="ea sb he">
            <div class="oc vg im/2 yn/12">
              <div class="ma ud">
                <h4 class="wa ui bj gj">
                  Note:
                </h4>
                <p class="ui dj hj">
          ...
          <div
            class="we cf nf wf sg"
          >
            <div class="je dl">
              <div
                class="ra va fc oc ld bl"
              >
                <img
                  src="src/assets/ecom-images/order-summaries/order-summary-03/image-01.jpg"
                  alt="product"
                  class="wb oc mg ng"
                />
              </div>
              ...
              >
                <div class="ra cm">
                  ...
                  <p
                    class="sb xi dj hj"
                  >
                    <span class="fb"> Color: White </span>
                    <span class="fb"> Size: Medium </span>
                  </p>
                </div>
      ...
      <div class="a da">
        <div class="ea sb he">
          <div class="oc vg ll/2 _n/12">
            <div class="na">
              <h3
                class="xa vi bj gj zm"
              >
                Shipping Method
              </h3>
              <p class="ui dj hj">
          ...
          <div class="oc vg bo/12">
            <div
              class="hb ti dm mm ho"
            >
              <p
                class="xa sb me ui dj gj"
              >
                <span> Subtotal </span>
                <span> $120.00 </span>
              </p>
              ...
              <p
                class="ib xa sb me hf nf zh ui dj gj"
              >
              ...
              <a
                href="filters.html"
                class="rounded-md sb oc je le bg gh ah si ui bj jj hk"
              >
                Continue Shopping
              </a>
            </div>
