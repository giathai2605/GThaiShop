...
<footer class="bg">
  <div class="e y ai gp">
    <div class="a da">
      <div class="ea sb he">
        <div class="oc vg im/2 xn/12 _p/12">
          <div class="pb xd">
            <a href="index.html" class="ma rb">
              <img
                src="src/assets/ecom-images/logo/logo-white.svg"
                alt="logo"
                class="od"
              />
            </a>
            <p
              class="ma sb je wi bj jj"
            >
              <span class="hi">
                <svg
                  width="28"
            ...
            <p
              class="xa sb ui dj pj"
            >
              <span class="hi"> 01. </span>
              29 Holles Place, Dublin 2 D02 YY46
            </p>
            <p class="sb ui dj pj">
              <span class="hi"> 02. </span>
        ...
        <div
          class="oc vg ll/2 im/2 yn/12 cq/12"
        >
          <div class="pb">
            <h3 class="xh vi bj jj">
              Top Categories
            </h3>
            <span
              class="ma qb lc yc xe wf"
            ></span>
            ...
            <ul class="qe">
              <li>
                <a
                  ...
                  class="hover:underline ui dj pj bk jk"
                >
                  Televisions
                </a>
              </li>
        ...
        <div
          class="oc vg ll/2 im/2 _n/12 cq/12"
        >
          <div class="pb">
            <h3 class="xh vi bj jj">
              Important Links
            ...
            <div>
              ...
              <form class="e">
                <input
                  ...
                  class="ec oc wf jg _g _j"
                />
                <button
                  class="d g/2 q ae/2 yf mh _g xi dj jj hk"
                >
                  Subscribe
                </button>
              </form>
  ...
  <div class="gg qh">
    <div class="a da">
      <div
        class="ea sb he je le"
      >
        <div
          class="ca oc vg im/2 gn xn/12 zp/3"
        >
          <p
            class="si ui dj pj hp"
          >
            © 2023 GThaiShop. All Rights Reserved.
          </p>
        </div>

        <div class="oc vg im/2 yn/12 zp/3">
          <div class="da oa in">
            <img
              src="src/assets/ecom-images/footers/footer-03/payment.svg"
              alt="payment"
              class="da od"
            />
          </div>
        ...
        <div class="oc vg im/2 _n/12 zp/3">
          <div
            class="oa sb je le pe nm in"
          >
            <span class="ui dj jj">
              Follow Us:
            </span>
