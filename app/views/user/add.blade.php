...
@section('content')
    ...
    <div class="flex flex-col flex-1 w-full sm:px-2">
        ...
        <div class="container grid px-6 mx-auto">
            ...
            @endif
            @if(isset($_SESSION['success'])&&isset($_GET['message']))
                <span>{{$_SESSION['success']}}</span>
            @endif
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
                <div class="w-full overflow-x-auto">
                    <form class="w-full" action="{{route('add-user-post')}}" method="post" enctype="multipart/form-data">
                        <div class="grid grid-cols-2 gap-3 sm:gap-5 list__form-group">
                            <div class="flex flex-col form__group">
                                <label class="text-sm text-gray-800">Full Name</label>
                                <input value="" type="text" name="name" id="full_name"
                                       class=" p-2 mt-1 glassmorphism border-gray-500 text-black text-sm rounded-lg"
                                       placeholder="Product name..." />

                            </div>
                            <div class="flex flex-col form__group">
                                <label class="text-sm text-gray-900">Avatar</label>
                            ...
                            <div class="flex flex-col form__group">
                                <label class="text-sm text-gray-900">Email</label>
                                <input value="" type="email" name="email" id="user_name"
                                       class="creat-user__input p-2 mt-1 glassmorphism border-gray-500 text-black focus:outline-none text-sm rounded-lg"
                                       placeholder="Price....." />

                            </div>
                            <div class="flex flex-col form__group">
                                <label class="text-sm text-gray-900">Phone</label>
                                <input value="" type="text" name="phone" id="user_name"
                                       class="creat-user__input p-2 mt-1 glassmorphism border-gray-500 text-black focus:outline-none text-sm rounded-lg"
                                       placeholder="Quantity....." />

                            </div>
                            <div class="flex flex-col form__group">
                                <label class="text-sm text-gray-900">Password</label>
                                <input value="" type="password" name="password" id="user_name"
                                       class="creat-user__input p-2 mt-1 glassmorphism border-gray-500 text-black focus:outline-none text-sm rounded-lg"
                                       placeholder="Quantity....." />

                            </div>
                            <div class="flex flex-col form__group">
                                <label class="text-sm text-gray-900">Re-Password</label>
                                <input value="" type="password" name="re-password" id="user_name"
                                       class="creat-user__input p-2 mt-1 glassmorphism border-gray-500 text-black focus:outline-none text-sm rounded-lg"
                                       placeholder="Quantity....." />
