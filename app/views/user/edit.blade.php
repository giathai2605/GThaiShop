        ...
        <div class="container grid px-6 mx-auto">
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
                <div class="w-full overflow-x-auto">
                    <form class="w-full" action="{{route('update-user/'.$user->id)}}" method="post" enctype="multipart/form-data">
                        <div class="grid grid-cols-2 gap-3 sm:gap-5 list__form-group">
                            <div class="flex flex-col form__group">
                                ...
                                <input value="{{$user->name}}" type="text" name="name" id="full_name"
                            ...
                            <div class="flex flex-col form__group">
                                ...
                                <input value="{{$user->avatar}}" type="file" name="avatar" id="avatar"
                            ...
                            <div class="flex flex-col form__group">
                                ...
                                <input value="{{$user->email}}" type="email" name="email" id="user_name"
                            ...
                            <div class="flex flex-col form__group">
                                ...
                                <input value="{{$user->phone}}" type="text" name="phone" id="user_name"
                                       class="creat-user__input p-2 mt-1 glassmorphism border-gray-500 text-black focus:outline-none text-sm rounded-lg"
