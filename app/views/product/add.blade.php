...
@section('content')
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
        ...
        <form class="w-full" action="{{route('add-product-post')}}" method="post" enctype="multipart/form-data">
            <div class="grid grid-cols-2 gap-3 sm:gap-5 list__form-group">
                ...
                <div class="flex flex-col form__group">
                    ...
                    <input value="" type="number" name="price" id="user_name"
                ...
                <div class="flex flex-col form__group">
                    ...
                    <input value="" type="number" name="quantity" id="user_name"
                           class="creat-user__input p-2 mt-1 glassmorphism border-gray-500 text-black focus:outline-none text-sm rounded-lg"
                ...
                <div class="flex flex-col form__group">
                    ...
                    <input value="" type="file" name="image" id="avatar"
                ...
                <div class="flex flex-col form__group">
                    ...
                    <input value="" type="text" name="detail" id="detail"
                           class=" p-2 mt-1 glassmorphism border-gray-500 text-black text-sm rounded-lg"
